...
import { Config, FreeScannerAdminService } from '../../admin.service';

@Component({
    selector: 'freescanner-admin-import-export-config',
    styleUrls: ['./import-export-config.component.scss'],
    templateUrl: './import-export-config.component.html',
})
export class FreeScannerAdminImportExportConfigComponent {
    @Output() config = new EventEmitter<Config>();

    constructor(
        private adminService: FreeScannerAdminService,
    ...
    async export(): Promise<void> {
        ...
        const fileName = 'freescanner.json';
