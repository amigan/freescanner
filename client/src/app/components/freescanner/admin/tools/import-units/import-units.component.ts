...
import { Config, FreeScannerAdminService, System } from '../../admin.service';

@Component({
    selector: 'freescanner-admin-import-units',
    styleUrls: ['./import-units.component.scss'],
    templateUrl: './import-units.component.html',
})
export class FreeScannerAdminImportUnitsComponent implements OnInit{
