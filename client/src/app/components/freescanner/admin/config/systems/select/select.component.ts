...
@Component({
    ...
    selector: 'freescanner-admin-systems-selection',
    styleUrls: ['./select.component.scss'],
    templateUrl: './select.component.html',
})
export class FreeScannerAdminSystemsSelectComponent {
    indeterminate = {
        everything: false,
        groups: [] as boolean[],
        systems: [] as boolean[],
    ...
    constructor(
        ...
        private matDialogRef: MatDialogRef<FreeScannerAdminSystemsSelectComponent>,
