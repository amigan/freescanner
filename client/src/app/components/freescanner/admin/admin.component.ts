...
import { AdminEvent, FreeScannerAdminService, Group, Tag } from './admin.service';

@Component({
    encapsulation: ViewEncapsulation.None,
    selector: 'freescanner-admin',
    styleUrls: ['./admin.component.scss'],
    templateUrl: './admin.component.html',
})
export class FreeScannerAdminComponent implements OnDestroy {
