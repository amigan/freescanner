...
import { Log, LogsQuery, LogsQueryOptions, FreeScannerAdminService } from '../admin.service';

@Component({
    selector: 'freescanner-admin-logs',
    styleUrls: ['./logs.component.scss'],
    templateUrl: './logs.component.html',
})
export class FreeScannerAdminLogsComponent {
    ...
    constructor(private adminService: FreeScannerAdminService, private ngFormBuilder: FormBuilder) { }
