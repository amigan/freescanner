...
import { AdminEvent, Config, FreeScannerAdminService } from '../admin.service';
...
@Component({
    selector: 'freescanner-admin-todos',
    styleUrls: ['./todos.component.scss'],
    templateUrl: './todos.component.html',
})
export class FreeScannerAdminTodosComponent implements OnDestroy, OnInit {
    todos: Todo[] = [];
    ...
    constructor(private adminService: FreeScannerAdminService) { }
